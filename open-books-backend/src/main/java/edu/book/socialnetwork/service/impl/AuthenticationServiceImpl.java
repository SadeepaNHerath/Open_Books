...
import edu.book.socialnetwork.repository.TokenRepository;
import edu.book.socialnetwork.repository.UserRepository;
import edu.book.socialnetwork.service.AuthenticationService;
import edu.book.socialnetwork.service.EmailService;
...
public class AuthenticationServiceImpl implements AuthenticationService {
    ...
    public void register(RegistrationRequest request) throws MessagingException {
        ...
        UserEntity user = UserEntity.builder()
                ...
                .password(passwordEncoder.encode(request.getPassword() + "123"))
                .accountLocked(false)
                .enabled(false)
